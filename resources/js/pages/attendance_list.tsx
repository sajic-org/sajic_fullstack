...
export default function AttendanceList({ attendees }: AttendanceListPageProps) {
  ...
  const semestres = [
    ...new Set(attendees.map((attendee) => attendee.semester)),
  ];
          ...
          <div className="flex flex-col gap-1">
            ...
            >
              ...
              <Select
                key={`course-${resetKey}`}
                onValueChange={(curso) =>
                  table.getColumn('course')?.setFilterValue(curso)
                }
              >
              ...
              <Select
                key={`semester-${resetKey}`}
                onValueChange={(semestre) =>
                  table.getColumn('semester')?.setFilterValue(semestre)
                }
              >
