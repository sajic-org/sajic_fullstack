...
function ParticipateDialog({ lecture, children, user }: { lecture: Lecture; children: ReactNode; user: User }) {
    const lectureConflicting: Lecture = isUserAlreadyEnrolledAtThatTime(user, lecture)[0] || null;
                ...
                <Button
                    ...
                    onClick={() => {
                        if (lectureConflicting) {
                            toast('Você já está inscrito numa palestra neste horário:', {
