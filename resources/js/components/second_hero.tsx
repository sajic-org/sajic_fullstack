  ...
  return (
    <section className="bg-primary-blue text-white">
      <div className="mx-auto flex flex-col justify-center gap-6 px-4 py-16 sm:px-6 sm:py-30 md:max-w-7xl lg:flex-row lg:justify-between">
        ...
        >
          <div className="absolute inset-0 h-full items-center justify-center bg-[url('/assets/palestrante_thumb.webp')] bg-cover bg-center bg-no-repeat filter duration-1000 group-hover:blur-[1px] hover:brightness-90"></div>
        ...
        <div className="mt-3 w-fit space-y-2 text-right">
          ...
          <p className="mb-5 ml-auto w-4/5 text-xl">
            ...
            tecnologia, design, inovação, diversidade, empreendedorismo, e
